...
class DB
{
    public:
        ...
        bool get_memtable(const std::string &key, std::string &value);
    ...
    public:
        ...
        bool get_from_rocksdb_mem(const std::string &key,uint32_t &sge_id,uint32_t &offset_of_sgement);
        void get_kv_with_position(uint32_t sge_id,uint32_t offset_of_sgement,const std::string &key, std::string &value);
