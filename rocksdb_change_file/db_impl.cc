...
Status DBImpl::GetImpl(const ReadOptions& read_options,
  ...
  if (!done &&  read_options.only_memtable==false) {
...
// bool DBImpl::Get_MemTable_interlnal(const ReadOptions& read_options,
//                    ColumnFamilyHandle* column_family, const Slice& key,
//                    PinnableSlice* value) {
//   return GetMemTableImpl(read_options, column_family, key, value);
// }
// bool DBImpl::GetMemTableImpl(const ReadOptions& read_options,
//                        ColumnFamilyHandle* column_family, const Slice& key,
//                        PinnableSlice* pinnable_val, bool* value_found,
//                        ReadCallback* callback, bool* is_blob_index) {
//   assert(pinnable_val != nullptr);
